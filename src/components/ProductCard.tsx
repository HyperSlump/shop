        ...
        >
            ...
            <div className={`absolute inset-0 bg-[var(--background)] backdrop-blur-md p-6 flex flex-col justify-between transition-all duration-300 z-30 ${isHovered ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4 pointer-events-none'}`}>
                ...
                <button
                    ...
                    disabled={isInCart}
                    className="w-full bg-primary text-primary-foreground font-bold uppercase py-3 text-xs hover:bg-white dark:hover:bg-white hover:text-black hover:border hover:border-black dark:hover:border-primary transition-all duration-300 relative group overflow-hidden"
                >
