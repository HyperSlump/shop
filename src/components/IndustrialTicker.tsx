...
export default function IndustrialTicker() {
    ...
    return (
        <div ref={containerRef} className="w-full border-y border-foreground/10 bg-[var(--background)] overflow-hidden py-4 select-none relative z-20 pointer-events-auto">
            {/* Row 1 / Gothic */}
            <div
            ...
            <div className="absolute top-0 right-8 px-2 bg-[var(--background)] border-x border-primary/20">
