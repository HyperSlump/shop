    ...
    return (
        <AnimatePresence>
            {isOpen && currentTrack && (
                ...
                >
                    <div className="mx-auto w-full max-w-[1480px] overflow-hidden rounded-xl border border-border/80 bg-card/90 shadow-[0_12px_30px_rgba(0,0,0,0.3)] backdrop-blur-xl">
                            ...
                            <div className="flex items-center justify-between md:w-auto md:justify-start md:gap-4">
                                <div className="flex items-center gap-3">
                                    <button
                                        ...
                                        className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-border bg-background text-foreground transition-colors hover:border-primary hover:text-primary"
