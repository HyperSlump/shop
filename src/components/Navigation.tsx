...
export default function Navigation() {
    ...
    return (
        <aside className="w-full md:w-20 h-16 md:h-screen sticky top-0 border-b md:border-b-0 md:border-r border-[var(--border)] flex flex-row md:flex-col items-center justify-between md:justify-center md:gap-12 px-4 md:p-4 z-40 bg-[var(--background)] animate-fade-in">
